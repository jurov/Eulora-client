/*
 * pawsnumberspromptwindow.cpp - Author: Ondrej Hurt
 *
...
// PAWS INCLUDES
#include "pawsnumberspromptwindow.h"
...
pawsNumbersPromptWindow::pawsNumbersPromptWindow(const pawsNumbersPromptWindow & origin)
...
bool pawsNumbersPromptWindow::PostSetup()
{
...
void pawsNumbersPromptWindow::Close()
{
    Hide();
    if (action != NULL)
    {
...
void pawsNumbersPromptWindow::LayoutWindow()
{
...
bool pawsNumbersPromptWindow::OnButtonPressed(int /*mouseButton*/, int /*keyModifier*/, pawsWidget* widget)
{
    if (action == NULL)
        return false;
...
void pawsNumbersPromptWindow::SetBoundaries(int minNumber, int maxNumber)
{
    csString numberStr;
    int div;
...
bool pawsNumbersPromptWindow::OnScroll(int /*scrollDirection*/, pawsScrollBar* /*widget*/)
{
...
bool pawsNumbersPromptWindow::OnChange(pawsWidget * widget)
{
    csString text;
...
void pawsNumbersPromptWindow::NumberWasEntered(int number)
{
    if (action != NULL)
    {
...
void pawsNumbersPromptWindow::Initialize(const csString & labelStr, int number, int minNumber, int maxNumber, 
...
pawsNumbersPromptWindow * pawsNumbersPromptWindow::Create(const csString & label,
                                                        int number, int minNumber, int maxNumber, 
                                                        iOnNumberEnteredAction * action,const char *name, int param)
{
    pawsNumbersPromptWindow * w = new pawsNumbersPromptWindow();
