/*
 * pawsnumberspromptwindow.h - Author: Ondrej Hurt
 *
...
/** 
 * pawsNumbersPromptWindow is window that lets the user enter a number
 */
class pawsNumbersPromptWindow : public pawsPromptWindow
{
public:
    pawsNumbersPromptWindow();
    pawsNumbersPromptWindow(const pawsNumbersPromptWindow & origin);
    //from pawsWidget:
    ...
    static pawsNumbersPromptWindow * Create(const csString & label,
...
CREATE_PAWS_FACTORY(pawsNumbersPromptWindow);
