...
public:
    ...
    inline const char * GetActionName(size_t idx)
    {
        switch (idx)
        {
            case KA_POS_X:      return "Position X";
            case KA_POS_Y:      return "Position Y";
            case KA_POS_Z:      return "Position Z";
            case KA_TOTARGET_X: return "To Target X";
            case KA_TOTARGET_Y: return "To Target Y";
            case KA_TOTARGET_Z: return "To Target Z";
        }
        return "";
    }
